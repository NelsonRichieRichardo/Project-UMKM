...
<body>
    ...
    <section id="top-picks" class="mt-8">
    ...
    <section id="front-store" class="mt-20">
        <img src="../../foto/pakde2.jpeg" alt="Pak'De Pemilik Usaha">
    </section>
</body>
</html>